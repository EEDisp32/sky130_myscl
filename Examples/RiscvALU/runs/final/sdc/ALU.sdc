...
set_input_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {alu_control[0]}]
set_input_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {alu_control[1]}]
set_input_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {alu_control[2]}]
set_input_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {alu_control[3]}]
...
set_output_delay 4.0000 -clock [get_clocks {clk}] -add_delay [get_ports {zero}]
###############################################################################
# Environment
###############################################################################
