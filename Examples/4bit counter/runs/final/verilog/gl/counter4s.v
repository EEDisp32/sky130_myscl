module counter4s (VGND,
 ...
 D_FF_pe f3 (.CLK(clknet_1_1__leaf_clk),
    ...
    .D(\d[3] ),
    .Q(net6));
 inverter i1 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\c[1] ),
    .A(\nc[1] ));
 inverter i2 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\c[2] ),
    .A(\nc[2] ));
 inverter i3 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\c[3] ),
